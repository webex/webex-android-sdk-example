...
### Option 2
   ...
   2. Add the `webex-android-sdk` library as a dependency for your app in the `build.gradle` file:
       ...
       - For Full SDK
         ```
         dependencies {
             implementation 'com.ciscowebex:webexsdk:3.15.1'
         }
         ```
       - For Meeting SDK
         ```
         dependencies {
         implementation 'com.ciscowebex:webexsdk-meeting:3.15.1'
         }
         ```
       - For WebexCalling SDK
         ```
         dependencies {
         implementation 'com.ciscowebex:webexsdk-wxc:3.15.1'
         }
         ```
      - For Messaging SDK
         ```
         dependencies {
         implementation 'com.ciscowebex:webexsdk-message:3.15.1'
         }
         ```
