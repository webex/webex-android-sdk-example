    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        DataBindingUtil.setContentView<ActivityHomeBinding>(this, R.layout.activity_home)
                ...
                .apply {
                    ...
                    binding.ivStartCall.setOnClickListener {
                        startActivity(Intent(this@HomeActivity, SearchActivity::class.java))
                    }

                    binding.ivMessaging.setOnClickListener {
                        startActivity(Intent(this@HomeActivity, MessagingActivity::class.java))
                    }

                    binding.ivUcLogin.setOnClickListener {
                        startActivity(UCLoginActivity.getIntent(this@HomeActivity))
                    }

                    binding.ivWebhook.setOnClickListener {
                    ...
                    binding.ivGetMe.setOnClickListener {
...
//                            data = Uri.parse("mailto:")
                    ...
                    binding.ivExtras.setOnClickListener {
