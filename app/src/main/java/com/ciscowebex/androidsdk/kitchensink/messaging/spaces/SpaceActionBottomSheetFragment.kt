...
class SpaceActionBottomSheetFragment(val editClickListener: (String, String) -> Unit,
                                     ...
                                     val showSpaceMembersWithReadStatusClickListener: (String) -> Unit) : BottomSheetDialogFragment() {
