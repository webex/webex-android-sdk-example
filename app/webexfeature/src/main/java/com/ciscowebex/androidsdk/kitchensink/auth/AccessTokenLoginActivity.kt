...
class AccessTokenLoginActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        titleView.text = getString(R.string.login_access_token)
        progressLayout.visibility = View.VISIBLE
        
        loginButton.setOnClickListener {
            loginFailedTextView.visibility = View.GONE
            if (tokenText.text.isEmpty()) {
                showDialogWithMessage(this@AccessTokenLoginActivity, R.string.error_occurred, resources.getString(R.string.login_token_empty_error))
            } else {
