...
class HomeActivity : BaseActivity() {
    ...
    private lateinit var ucLoginStatusTextView: TextView
    private lateinit var ucServerConnectionStatusTextView: TextView
    private lateinit var ivStartCall: ImageView
    private lateinit var ivMessaging: ImageView
    private lateinit var ivUcLogin: ImageView
    private lateinit var ivWebhook: ImageView
    private lateinit var ivLogout: ImageView
    private lateinit var ivGetMe: ImageView
    private lateinit var ivFeedback: ImageView
    private lateinit var ivSetup: ImageView
    private lateinit var ivExtras: ImageView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        webexViewModel.initialSpacesSyncCompletedLiveData.observe(this@HomeActivity) {
            ...
            Snackbar.make(rootView, getString(R.string.initial_spaces_sync_completed), Snackbar.LENGTH_LONG).show()
        }
        ...
        rootView = findViewById(R.id.rootHomeActivity)
        progressLayout = findViewById(R.id.progressLayout)
        versionTextView = findViewById(R.id.version)
        ucLoginStatusTextView = findViewById(R.id.uc_login_status_textView)
        ucServerConnectionStatusTextView = findViewById(R.id.uc_server_connection_status_textView)
        ivStartCall = findViewById(R.id.iv_startCall)
        ivMessaging = findViewById(R.id.iv_messaging)
        ivUcLogin = findViewById(R.id.iv_ucLogin)
        ivWebhook = findViewById(R.id.iv_webhook)
        ivLogout = findViewById(R.id.iv_logout)
        ivGetMe = findViewById(R.id.iv_getMe)
...
//                data = Uri.parse("mailto:")
    ...
    private fun checkForInitialSpacesSync() {
        if (!webexViewModel.isSpacesSyncCompleted()) {
            Snackbar.make(rootView, getString(R.string.syncing_spaces), Snackbar.LENGTH_SHORT).show()
        }
    }
    ...
    private fun updateUCData() {
        ...
        if (webexViewModel.isUCServerLoggedIn) {
            ucLoginStatusTextView.visibility = View.VISIBLE
            if(webexViewModel.getCallingType() == Phone.CallingType.WebexCalling)  {
                ucLoginStatusTextView.text = getString(R.string.wxc_loggedIn)
            } else if(webexViewModel.getCallingType() == Phone.CallingType.WebexForBroadworks)  {
                ucLoginStatusTextView.text = getString(R.string.webexforbroadworks_loggedIn)
            } else if (webexViewModel.getCallingType() == Phone.CallingType.CUCM){
                ucLoginStatusTextView.text = getString(R.string.uc_loggedIn)
            }
        } else {
            ucLoginStatusTextView.visibility = View.GONE
        }
