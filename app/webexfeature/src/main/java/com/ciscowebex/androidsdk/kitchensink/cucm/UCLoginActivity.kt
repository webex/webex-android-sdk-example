...
import com.ciscowebex.androidsdk.kitchensink.base.KitchenSinkApp.Companion.isUCSSOLogin
...
class UCLoginActivity : BaseActivity() {
    private lateinit var connectPhoneServicesButton: Button
    private lateinit var disconnectPhoneServicesButton: Button
    private lateinit var ssologinWebview: WebView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tag = "UCLoginActivity"
        setContentView(R.layout.activity_cucm_login)

        // Initialize views with findViewById
        connectPhoneServicesButton = findViewById(R.id.connectphoneservices)
        disconnectPhoneServicesButton = findViewById(R.id.disconnectphoneservices)
        ssologinWebview = findViewById(R.id.ssologinWebview)
        ...
        if (webexViewModel.getCallingType() == Phone.CallingType.WebexCalling || webexViewModel.getCallingType() == Phone.CallingType.WebexForBroadworks) {
            connectPhoneServicesButton.setOnClickListener {
            ...
            disconnectPhoneServicesButton.setOnClickListener {
            ...
            connectPhoneServicesButton.visibility = View.GONE
            disconnectPhoneServicesButton.visibility = View.GONE
        }
    ...
    private fun onActionShowSSOLogin(ssoUrl: String) {
        ...
        isUCSSOLogin = true
        UCSSOWebViewAuthenticator.launchWebView(ssologinWebview, ssoUrl, CompletionHandler { result ->
            if (result.isSuccessful) {
    ...
    private fun updatePhoneServiceConnectionUI(status: String) {
        ucServerConnectionStatusTextView.text = status
    }

    private fun updateUCLoginStatusUI(status: String) {
        ucLoginStatusTextView.text = status
    }
