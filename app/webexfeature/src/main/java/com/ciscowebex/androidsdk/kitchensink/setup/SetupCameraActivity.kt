...
class SetupCameraActivity: BaseActivity() {
    ...
    private lateinit var preview: MediaRenderView
    ...
    private lateinit var textLimit: EditText
    private lateinit var setLimitButton: Button
    private lateinit var isPhotoCaptureSupportedButton: RadioGroup
    private lateinit var isPhotoCaptureSupportedTrue: RadioButton
    private lateinit var isPhotoCaptureSupportedFalse: RadioButton
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        changeBgButton = findViewById(R.id.changeBgButton)
        cameraRadioGroup = findViewById(R.id.cameraRadioGroup)
        ...
        isPhotoCaptureSupportedButton = findViewById(R.id.isPhotoCaptureSupportedButton)
        isPhotoCaptureSupportedTrue = findViewById(R.id.isPhotoCaptureSupportedTrue)
        isPhotoCaptureSupportedFalse = findViewById(R.id.isPhotoCaptureSupportedFalse)
    ...
    private fun startPreview() {
        ...
        cameraCap = getDefaultCamera()
        webexViewModel.startPreview(preview)
    }
