...
class BackgroundOptionsBottomSheetFragment(
    ...
    private lateinit var virtualBackgrounds: RecyclerView
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.bottom_sheet_virtual_backgrounds, container, false)
        virtualBackgrounds = view.findViewById(R.id.virtualBackgrounds)
